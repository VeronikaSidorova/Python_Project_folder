...
class TestVacancyFunctions(unittest.TestCase):
    ...
    def test_filter_vacancies(self): # type: ignore
    ...
    def test_get_vacancies_by_salary(self): # type: ignore
    ...
    def test_sort_vacancies(self): # type: ignore
    ...
    def test_get_top_vacancies(self): # type: ignore
        top_n = 2
    ...
    def test_print_vacancies(self): # type: ignore
